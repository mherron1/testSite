let odds = 
[
  { name: 'Alex Munoz', odds: '2.25' },
  { name: 'Luis Pena', odds: '1.68' },
  { name: 'Alexandr Romanov', odds: '1.73' },
  { name: 'Juan Espino', odds: '2.20' },
  { name: 'Austin Hubbard', odds: '1.57' },
  { name: 'Dakota Bush', odds: '2.63' },
  { name: 'Bartosz Fabinski', odds: '1.89' },
  { name: 'Gerald Meerschaert', odds: '2.10' },
  { name: 'Justine Kish', odds: '3.50' },
  { name: 'Tracy Cortez', odds: '1.42' },
  { name: 'Tony Gravely', odds: '1.33' },
  { name: 'Anthony Birchak', odds: '3.72' },
  { name: 'Zarah Fairn Dos Santos', odds: '2.10' },
  { name: 'Josiane Nunes', odds: '1.80' },
  { name: 'Gerald Meerschaert', odds: '2.10' },
  { name: 'Bartosz Fabinski', odds: '1.83' },
  { name: 'Jessica Penne', odds: '3.50' },
  { name: 'Lupita Godinez', odds: '1.36' },
  { name: 'Tracy Cortez', odds: '1.40' },
  { name: 'Justine Kish', odds: '3.50' },
  { name: 'Ricardo Ramos', odds: '1.91' },
  { name: 'Bill Algeo', odds: '1.91' },
  { name: 'Luis Pena', odds: '1.73' },
  { name: 'Alex Munoz', odds: '2.25' },
  { name: 'Abdul Razak Alhassan', odds: '1.33' },
  { name: 'Jacob Malkoun', odds: '3.50' },
  { name: 'Andrei Arlovski', odds: '1.86' },
  { name: 'Chase Sherman', odds: '2.10' },
  { name: 'Drakkar Klose', odds: '2.01' },
  { name: 'Jeremy Stephens', odds: '1.83' },
  { name: 'Robert Whittaker', odds: '1.39' },
  { name: 'Kelvin Gastelum', odds: '3.27' },
  ...
  { name: 'Jeffrey Molina', odds: '1.94' },
  { name: 'Qileng Aori', odds: '1.91' },
  { name: 'Kamaru Usman', odds: '1.25' },
  { name: 'Jorge Masvidal', odds: '4.20' },
  { name: 'Valentina Shevchenko', odds: '1.25' },
  { name: 'Jessica Andrade', odds: '4.20' },
  { name: 'Weili Zhang', odds: '1.53' },
  { name: 'Rose Namajunas', odds: '2.55' },
  ...
  { name: 'Jimmy Flick', odds: '1.40' },
  { name: 'Francisco Figueroa', odds: '3.00' },
  ...
  { name: 'Conor McGregor', odds: '1.93' },
  { name: 'Gilbert Burns', odds: '2.30' },
  { name: 'Stephen Thompson', odds: '1.69' },
