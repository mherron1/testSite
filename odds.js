let odds = [
  { name: "Ariane Carnelossi", odds: "1.40" },
  { name: "Na Liang", odds: "2.75" },
  { name: "Danaa Batgerel", odds: "1.53" },
  { name: "Kevin Natividad", odds: "2.80" },
  { name: "Rodrigo Vargas", odds: "3.00" },
  { name: "Zhu Rong", odds: "1.41" },
  { name: "Pat Sabatini", odds: "1.44" },
  { name: "Tristan Connelly", odds: "3.25" },
  { name: "Brendan Allen", odds: "1.62" },
  { name: "Karl Roberson", odds: "2.40" },
  { name: "Dwight Grant", odds: "1.51" },
  { name: "Stefan Sekulić", odds: "2.80" },
  { name: "Alex Oliveira", odds: "2.30" },
  { name: "Randy Brown", odds: "1.73" },
  { name: "Anthony Smith", odds: "2.87" },
  { name: "Jimmy Crute", odds: "1.50" },
  { name: "Chris Weidman", odds: "1.80" },
  { name: "Uriah Hall", odds: "2.20" },
  { name: "Valentina Shevchenko", odds: "1.22" },
  { name: "Jessica Andrade", odds: "4.85" },
  { name: "Weili Zhang", odds: "1.50" },
  { name: "Rose Namajunas", odds: "2.79" },
  { name: "Kamaru Usman", odds: "1.28" },
  ...
  { name: "Poliana Botelho", odds: "1.62" },
  ...
  { name: "Israel Adesanya", odds: "1.45" },
